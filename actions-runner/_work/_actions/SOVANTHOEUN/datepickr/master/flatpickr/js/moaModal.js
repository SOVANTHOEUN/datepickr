		...
		if (obj.overlayClose !== false){
			_modalWrapper.click(function(e){
				if (this === e.target || e.target === clone[0]){
					...
					var video	=	'<iframe width="450" height="253" src="https://www.youtube.com/embed/D0GGvmA1JgE" allowfullscreen title="경비지출관리 솔루션 bizplay 소개동영상" style="border:0;"></iframe>';
					$('.video').html(video);
				}
			});
		}
